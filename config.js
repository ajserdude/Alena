...
module.exports = {
    VERSION: 'v3.0.0',
    CHANNEL: 'undefined',
    SESSION: process.env.ALENA_CODE === undefined ? 'apikey' : process.env.ALENA_CODE,
    ...
    NBSK: process.env.ALL_NUMBER === undefined ? '917025994168' : process.env.ALL_NUMBER,
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ᴊᴀsɪʟ¹¹;ᴀʟᴇɴᴀ;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'ᴊᴀsɪʟ¹¹' : process.env.OWNER_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/jasil_xr' : process.env.IG,
    ...
    SKDL: process.env.DIALOGUE === undefined ? '️‍🔥𝑚𝑤𝑜𝑛𝑒 𝑝𝑜𝑤𝑒𝑟 𝑎𝑙𝑙𝑒🔥' : process.env.DIALOGUE,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SOURAV: process.env.SK_BLOCK === undefined ? 'false' : process.env.SK_BLOCK,
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ᴊsʟ¹¹|ᴀʟᴇɴᴀ' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'jasil' : process.env.AUTO_FAKE,
    ...
    YAK: process.env.YAK === undefined ? '917025994178' : process.env.YAK,
